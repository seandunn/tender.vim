...
hi IncSearch guifg=#ffffff ctermfg=235 guibg=#111111 ctermbg=15 gui=NONE cterm=NONE
hi LineNr guifg=#444444 ctermfg=238 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi Conceal guibg=#222222 gui=italic
...
hi Search guifg=#ffffff ctermfg=15 guibg=black ctermbg=NONE gui=italic,bold cterm=italic,bold
hi SpecialKey guifg=#444444 ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi SpellBad guifg=#f43753 ctermfg=203 guibg=NONE ctermbg=NONE gui=underline,italic cterm=underline,italic
hi SpellLocal guifg=#d3b987  ctermfg=180 guibg=NONE ctermbg=NONE gui=underline,italic cterm=underline,italic
...
hi Comment guifg=#666666 ctermfg=242 guibg=NONE ctermbg=NONE gui=NONE cterm=italic
...
hi Error guifg=#eeeeee ctermfg=255 guibg=#be2826 ctermbg=203 gui=underline cterm=underline
...
hi NeomakeMessageSignDefault ctermbg=0 guibg=#808080
hi NeomakeWarningSignDefault ctermfg=203 ctermbg=000 guifg=#f43753 guibg=#000000
hi NeomakeErrorSignDefault   ctermfg=203 ctermbg=000 guifg=#f43753 guibg=#000000
hi NeomakeInfoSignDefault    ctermfg=150 ctermbg=000 guifg=#bfc476 guibg=#000000
